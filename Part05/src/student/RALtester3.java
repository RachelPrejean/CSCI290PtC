...
public class RALtester3 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try{
        System.out.println("TEST: toArray with an array too big:");
        String[] b = new String[ralist.size()*2];
        ralist.toArray(b);
        ...
        try{
        System.out.println("TEST: toArray with an array too small:");
        String[] c = new String[ralist.size()/2];
        ralist.toArray(c);
